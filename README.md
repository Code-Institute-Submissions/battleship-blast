...
[Link to deployed site](x)



_Battleships Blasts_ is an online game of the classic game of Battleships. The pkayer is presneted with a 5 x 5 grid where 5 hidden battleships are randomly generated by the computer. The player has 15 missils to sink ALL ships and defeat the enemy!
